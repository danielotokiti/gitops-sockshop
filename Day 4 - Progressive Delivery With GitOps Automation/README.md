# Day 4 - Progressive Delivery With GitOps Automation
...
# Screenshots:
- Github repo manifest file
- Argo Rollouts dashboard or CLI showing the front-end rollout status.
- Confirmation of successful rollout.
- All pods running perfectly fine.
- Sock-shop front-end working after update.
